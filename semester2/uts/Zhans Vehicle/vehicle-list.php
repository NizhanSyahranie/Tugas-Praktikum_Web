...
<head>
    ...
    <title>Zhan's Vehicle | List</title>
            ...
            <div class="explore-vehicle-container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="explore-vehicle-single">
                            ...
                            <div class="explore-vehicle-content">
                                ...
                                <p class="explore-vehicle-price"><span>Rp. 20.000.000</span> </p>
                                <ul class="list-unstyled explore-vehicle-details">
                                    <li><a href="#">2022</a></li>
                                    <li><a href="#">Manual</a></li>
                                    <li><a href="#">Sport</a></li>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="explore-vehicle-single">
                            <div class="explore-vehicle-img">
                                <img src="assets/img/motor/motor.jpg" alt="">
                            </div>
                            <div class="explore-vehicle-content">
                                <h5 class="explore-vehicle-sub-title">Roda Dua</h5>
                                <h3 class="explore-vehicle-title">
                                    <a href="vehicle-details.php">Honda Vario 160</a>
                                </h3>
                                <p class="explore-vehicle-price"><span>Rp. 15.000.000 </span></p>
                                <ul class="list-unstyled explore-vehicle-details">
                                    <li><a href="#">2021</a></li>
                                    <li><a href="#">Matic</a></li>
                                    <li><a href="#">USB Charge</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="explore-vehicle-single">
                            ...
                            <div class="explore-vehicle-content">
                                ...
                                <p class="explore-vehicle-price"><span>Rp. 17.000.000 </span></p>
                                <ul class="list-unstyled explore-vehicle-details">
                                    <li><a href="#">2021</a></li>
                                    <li><a href="#">Matic</a></li>
                                    <li><a href="#">USB Charge</a></li>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="explore-vehicle-single">
                            ...
                            <div class="explore-vehicle-content">
                                ...
                                <p class="explore-vehicle-price"><span>Rp. 7.000.000 </span></p>
                                <ul class="list-unstyled explore-vehicle-details">
                                    <li><a href="#">2021</a></li>
                                    <li><a href="#">Matic</a></li>
                                    <li><a href="#">USB Charge</a></li>
